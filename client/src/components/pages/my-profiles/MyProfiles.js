...
const MyProfiles = ({
    ...
    useEffect(() => {
        getProfileById('5dac5f1f99a0e4424887d6fa');
    }, [getProfileById, '5dac5f1f99a0e4424887d6fa']);
                ...
                <div className="card-body">
                    <div className="card">
                        <div className="card-body profile-status">
                            <span className="mb-2">Your profile is
                    ...
                    <div className="col-md-6 col-sm-12">
                        <div className="row" align="center">
                            <div className="col-md-6 ">
                                <img src={profile.cover_photo} alt="profile cover" className="img-fluid" />
                            </div>
                            <div className="col-md-6">
                                <h5 className="girl-name">{profile.user.nickname}</h5>
                                <h6 className="position-text">
                                    <span>13/26</span> <br />
                                    position in the gallery
                            </h6>
                                <button type="button" className="btn btn-primary btn-sm btn-boost">
