...
class EscortsGirls extends React.Component {
    ...
    renderGirlsFromCanton() {
        ...
        return this.props.profiles.filter(profile => profile.canton.toLowerCase() === canton).map(girl => {
            return (
                    ...
                    <article className="content">
                        <div className="contentHolder">
                            ...
                            <Link to="/describe-content">
                                <img src={girl.cover_photo} alt="" className="img-fluid" />
                            </Link>
    ...
    render() {
        ...
        if (this.renderGirlsFromCanton().length < 1) {
            message = <h4 className="text-center no-annoucments-heading">For now, no announcements available.</h4>
        }
        return (
